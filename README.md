...
3. Showing the top 30 words that appear frequently on positive and negative sentiment
...
5. Showing the frequent words on positive and negative sentiment using WordCloud
